...
class Wood: public virtual Material {
private:
...
public:
    ...
    Wood(Matrix *m, Material *mat1, Material *mat2, int octaves_, float frequency_, float amplitude_): Material(Vec3f(1, 1, 1)), mappingMatrix(m), material1(mat1), material2(mat2), octaves(octaves_), frequency(frequency_), amplitude(amplitude_) {}
    ~Wood() { delete mappingMatrix; delete material1; delete material2; }
